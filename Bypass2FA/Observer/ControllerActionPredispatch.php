...
use Magento\TwoFactorAuth\Observer\ControllerActionPredispatch as ParentControllerActionPredispatch;
use PHPStudios\Bypass2FA\Helper\Data;

class ControllerActionPredispatch extends ParentControllerActionPredispatch
{
    /**
     * @var AuthSession
     */
